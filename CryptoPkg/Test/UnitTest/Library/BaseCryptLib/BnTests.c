...
GLOBAL_REMOVE_IF_UNREFERENCED CONST UINT8  BnOperationModOdd[] = {
  0x48, 0xbe, 0xcb, 0xd5, 0x36, 0x2e, 0x93, 0x0b, 0x51, 0x45, 0x9c, 0x7d, 0xe7, 0xfe, 0x47, 0xaa,
  0xc5, 0xd3, 0x4b, 0x4f, 0x06, 0x24, 0xb4, 0x31, 0x83, 0x55, 0xb5, 0xf0, 0xda, 0x14, 0xca, 0x45
};
...
// (BnOperationA + BnOperationB) % BnOperationMod
...
// 1=(BnOperationA*BnResultInverseMod) % BnOperationMod
...
// (BnOperationA ^ BnOperationExp) % BnOperationModOdd
GLOBAL_REMOVE_IF_UNREFERENCED CONST UINT8  BnResultExpMod[] =  {
  0x1a, 0xa8, 0xb2, 0x51, 0xe9, 0x1c, 0x21, 0xf9, 0x30, 0xa0, 0xc1, 0xb3, 0x91, 0x90, 0xaf, 0x5f,
  0x10, 0x02, 0xc5, 0xb8, 0xc2, 0xde, 0xf1, 0x73, 0x50, 0x53, 0x66, 0x9f, 0x59, 0x1f, 0xf1, 0x02
};
  ...
  )
{
  ...
  // C=(A^B)%D
  BnContext->BnD = BigNumFromBin (BnOperationModOdd, sizeof (BnOperationModOdd));
